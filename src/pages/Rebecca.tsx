...
const Rebecca = memo(() => {
  ...
  return (
    ...
    >
            ...
            <div 
              ...
              onClick={(e) => {
                ...
                if (home3dAudioRef.current) {
                  home3dAudioRef.current.currentTime = 0;
                  home3dAudioRef.current.play().catch(error => {
                    console.log('⚠️ No se pudo reproducir el sonido HOME 3D (cerrar):', error);
                  });
                }
                setIsActive(false);
      ...
      <section 
        ref={ctaSectionRef}
        className={`call-to-action-section ${isEffectActive ? 'active-effect' : ''}`}
        id="cta-section"
        ...
        <div className="footer-content">
          <div className="footer-info">
            <div className="newsletter-section">
              ...
              <h3>suscríbete a<br />nuestro boletín</h3>
              <p>Recibe las últimas novedades de nuestra fecha de lanzamiento y los increíbles descuentos y regalos que tenemos para ti.</p>
              <form 
              ...
              >
                ...
                />
                <button type="submit" id="boletinSubmitButton" className="newsletter-button">→</button>
              </form>
              ...
              >
                <div className="ai-matrix-container">
                  ...
                  <div className="holo-text">
                    <span className="text-glitch" data-text="VOLVER AL INICIO">VOLVER AL INICIO</span>
                  </div>
          ...
          <div className="contact-info">
            ...
            <div className="contact-item address">
              ...
              <p>Alcázar 356, oficina 603<br />Rancagua Centro, Chile</p>
