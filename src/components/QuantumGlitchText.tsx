...
const QuantumGlitchText: React.FC<QuantumGlitchTextProps> = ({
  text,
  fontSize = 54,
  style,
  inactive = false,
    ...
    >
          ...
          style={{
            ...
            transform: !inactive
              ...
              : `translate3d(0,0,0) rotateY(${
                  parallax.x * (18 + i * 12)
                }deg) rotateX(${-parallax.y * (14 + i * 8)}deg)`,
      ...
      <span
        style={{
          ...
          transform: !inactive
            ? `translate3d(0,0,0) rotateY(0deg) rotateX(0deg)`
            : `translate3d(0,0,0) rotateY(${parallax.x * 28}deg) rotateX(${
                -parallax.y * 18
              }deg)`,
          willChange: "transform",
        }}
        ...
        Array.from({ length: 2 }, (_, i) => (
          <span
            ...
            style={{
              ...
              color: randomFrom([...grays, ...whites, ...blacks]),
              opacity: 0.18 + Math.random() * 0.22,
              textShadow: `0 0 24px ${randomFrom(grays)}, 0 0 32px ${randomFrom(
                whites
              )}`,
              fontFamily: "inherit",
              pointerEvents: "none",
